...
left join claims as c
    on
        e.earned_year_month = c.loss_year_month
        and e.country = c.country
        and e.partner_code = c.partner_code
        and e.product_code = c.product_code
left join {{ ref('dim_product') }} as pr on e.product_code = pr.product_code
